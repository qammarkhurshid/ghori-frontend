            ...
            (function () {
                ...
                switch (o) {
                  ...
                  case s._const.modifyTextElement:
                    ...
                    s.textDiff(
                      ...
                      i.parentNode instanceof HTMLTextAreaElement &&
                  ...
                  case s._const.removeTextElement:
                    ...
                    var p = i.parentNode;
                    p.removeChild(i),
                      p instanceof HTMLTextAreaElement && (p.value = "");
                    break;
                  case s._const.addTextElement:
                    ...
                    if (
                      ...
                      return !1;
                    i.insertBefore(n, i.childNodes[u] || null),
                      i.parentNode instanceof HTMLTextAreaElement &&
              ...
              function M(t, e) {
                ...
                if (t instanceof Text || t instanceof Comment) s.data = t.data;
                  ...
                  e.valueDiffing &&
                    (t instanceof HTMLTextAreaElement && (s.value = t.value),
                      ...
                      if (d) {
                        ...
                        return (
                          p &&
                            ...
                            p.node.childNodes.push(u)),
                          ""
                        );
                      }
                      if (l) {
                        if (
                          ((s = S(o)), n++, !s.voidElement && h && "<" !== h)
                        ) {
                            ...
                            if (i.length > n.length)
                              ...
                              r = r.concat([
                                new x()
                                  ...
                                  .setValue(this.options._const.oldValue, g(u))
                                  .setValue(this.options._const.newValue, g(p))
                                  .setValue(
                                    this.options._const.route,
                                    s.concat(l)
                                  ),
                    ...
                    (t.prototype.attemptGroupRelocation = function (
                      ...
                      for (
                        var a,
                          ...
                          h = (function (t, e, s) {
                            var i = t.childNodes
                                ? w(t.childNodes.length, !0)
                                : [],
                              n = e.childNodes
                                ? w(e.childNodes.length, !0)
                                : [],
                              a = 0;
                            return (
                            ...
                            if ("#text" === (l = t.childNodes[_]).nodeName)
                              ...
                              m.push(
                                new x()
                                  ...
                                  .setValue(this.options._const.element, g(l))
                              ),
                                u.splice(b, 1),
                                (f = Math.min(u.length, p.length)),
                                (b -= 1);
                          else if (!0 === p[b])
                            "#text" === (l = e.childNodes[b]).nodeName
                              ? (m.push(
                                  new x()
                                    .setValue(
                                      this.options._const.action,
              ...
              const j = (t, e) => {
                ...
                F = (t, e, s, n, a) => {
                  ...
                  t.headings
                    ? (o.headings = t.headings.map((t) => B(t)))
                    : e?.tHead
                    ? (o.headings = Array.from(
                        e.tHead.querySelectorAll("th")
                      ).map((t, e) => {
                        const o = ((t) => {
                          const e = M(t, { valueDiffing: !1 });
                          let s;
                          return (
                            (s =
                              !e.childNodes ||
              ...
              const J = {
                ...
                Q = (t, e, s, i, n) => {
                  let a = [];
                  if (
                    (n.firstLast && a.push(W(1, n.firstText, n)), n.nextPrev)
                  ) {
                    const e = t ? 1 : s - 1;
                    a.push(W(e, n.prevText, n, { hidden: t }));
                  }
                  let o = [...Array(i).keys()].map((t) =>
                    W(t + 1, String(t + 1), n, { active: t === s - 1 })
                  );
                  if (
                    (n.truncatePager &&
                      (o = ((t, e, s, i) => {
                    ...
                    const t = e ? i : s + 1;
                    a.push(W(t, n.nextText, n, { hidden: e }));
                  }
              ...
              class Z {
                      ...
                      e instanceof Element &&
                        (e.hasAttribute("data-editor-cancel")
                          ...
                          : e.hasAttribute("data-editor-save") &&
                            (t.preventDefault(), this.saveCell(r.value)));
                    });
                }
                saveCell(t) {
                ...
                saveRow(t, e) {
                    ...
                    (this.dt.data.data[this.data.rowIndex] = this.dt.data.data[
                      ...
                      if ("number" === i) r = { data: parseFloat(a) };
                        ...
                        const t =
                          ...
                          this.dt.options.format;
                        r = { data: n, order: j(String(n), t) };
                      } else r = { data: n };
                      return r;
                    }));
                  const i = this.dt.data.data[this.data.rowIndex].map(
                  ...
                  (this.data = {}),
                    ...
                    this.closeModal(),
                    (this.editing = !1),
                    this.dt.emit("editable.save.row", i, s, e);
                }
                openModal() {
              ...
              class K {
                ...
                init() {
                  ...
                  if (!t) {
                    ...
                    e ? e.appendChild(t) : this.dt.wrapperDOM.appendChild(t),
              ...
              (exports.DataTable = class {
                constructor(t, e = {}) {
                  ...
                  const i = { ...J.diffDomOptions, ...e.diffDomOptions },
                    n = { ...J.labels, ...e.labels },
                  ...
                  (this.options = {
                    ...
                    (this._dd = new L(this.options.diffDomOptions || {})),
                    (this.initialized = !1),
                    (this._events = {}),
                    (this._currentPage = 0),
                    (this.onFirstPage = !0),
                    ...
                    t(e) &&
                      (!e.headings || this.hasHeadings || this.hasRows
                        ? e.data &&
                          ...
                          (s = e.data.map((t) =>
                            t.map((t, e) => q(t, this.columns.settings[e]))
                          ))
                        : (this.data = F(
                            e,
                            void 0,
